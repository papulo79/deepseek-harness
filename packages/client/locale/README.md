...
The Host persists the preference through the settings service. Every authenticated browser binds that settings scope, so a LAN-paired page and the loopback page share one selection.
